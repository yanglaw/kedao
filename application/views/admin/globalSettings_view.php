...
<section class="column width8 first">
	<h3><?php $clang->eT("Global settings"); ?></h3>
	<hr/>
	<div id='tabs'>
	    <ul>
	        <li><a href='#overview' class="corner-tl"><?php $clang->eT("Overview & update"); ?></a></li>
	        ...
	        <li><a href='#interfaces' class="corner-tr"><?php $clang->eT("Interfaces"); ?></a></li>
	    </ul>
    <form class='form30' id='frmglobalsettings' name='frmglobalsettings' action='<?php echo $this->createUrl("admin/globalsettings"); ?>' method='post'>
        <div id='overview'>
        	<div class="colgroup leading">
            	...
            	<h4><?php $clang->eT("System overview"); ?></h4>
            	<hr /><table class='no-style full'>
            	<tbody>
                <tr>
                    <td><?php $clang->eT("Users"); ?>:</td>
                    <td class="ta-right"><?php echo $usercount; ?></td>
                </tr>
                <tr>
                    <td><?php $clang->eT("Surveys"); ?>:</td>
                    <td class="ta-right"><?php echo $surveycount; ?></td>
                </tr>
                <tr>
                    <td><?php $clang->eT("Active surveys"); ?>:</td>
                    <td class="ta-right"><?php echo $activesurveycount; ?></td>
                </tr>
                <tr>
                    <td><?php $clang->eT("Deactivated result tables"); ?>:</td>
                    <td class="ta-right"><?php echo $deactivatedsurveys; ?></td>
                </tr>
                <tr>
                    <td><?php $clang->eT("Active token tables"); ?>:</td>
                    <td class="ta-right"><?php echo $activetokens; ?></td>
                </tr>
                <tr>
                    <td><?php $clang->eT("Deactivated token tables"); ?>:</td>
                    <td class="ta-right"><?php echo $deactivatedtokens; ?></td>
                </tr>
                <?php
                    ...
                    ?>
                    <tr>
                        <td><?php $clang->eT("Used/free space for file uploads"); ?>:</td>
                        <td class="ta-right"><?php echo sprintf('%01.2F',$fUsed); ?> MB / <?php echo sprintf('%01.2F',Yii::app()->getConfig('iFileUploadTotalSpaceMB')-$fUsed); ?> MB</td>
                    </tr>
                    <?php
                    }
                ?>
            ...
            <?php
                ...
                {
                ?>
                <p><input type="button" class="btn btn-blue" onclick="window.open('<?php echo Yii::app()->getController()->createUrl("admin/globalsettings/showphpinfo"); ?>')" value="<?php $clang->eT("Show PHPInfo"); ?>" /></p>
                    <?php
                    }
                ?>
                <p></p>
                <h4><?php echo $clang->eT("Updates"); ?></h4>
                <ul>
...
<div class="colgroup leading">
	<div class="column width3 first">
		<div class="box">
			<input type='button' class="btn btn-green" onclick='$("#frmglobalsettings").submit();' class='standardbtn' value='<?php $clang->eT("Save settings"); ?>' />
		</div>
	</div>
</div>
