...
<div>
	<h3 id="Survey Globalsetting"><?php $clang->eT("Global settings"); ?></h3>
</div>
<script>
	...
	<div class="jquery_tabs">
		<form class="ym-form" id='frmglobalsettings' name='frmglobalsettings' action='<?php echo $this->createUrl("admin/globalsettings"); ?>' method='post'>
	
		<h4><?php $clang->eT("Overview & update"); ?></h4>
		<div class="tabbody">
			<table class='bordertable'>
                <tr>
                    <th width="30%"><?php $clang->eT("Users"); ?>:</th><td><?php echo $usercount; ?></td>
                </tr>
                <tr>
            ...
            <?php
                ...
                {
                ?>
                <p><input type="button" class="ym-button" onclick="window.open('<?php echo Yii::app()->getController()->createUrl("admin/globalsettings/showphpinfo"); ?>')" value="<?php $clang->eT("Show PHPInfo"); ?>" /></p>
                    <?php
                    }
                ?>
		</div>
	...
	<h4><?php $clang->eT("Email settings"); ?></h4>
	<div class="tabbody">
		<ul>
	...
	<h4><?php $clang->eT("Bounce settings"); ?></h4>
	<div class="tabbody">
			<ul>
	...
	<h4><?php $clang->eT("Presentation"); ?></h4>
	<div class="tabbody">
			<ul>
	...
	<div class="tabbody">
			...
			<div class="ym-fbox-button"><input type='button' onclick='$("#frmglobalsettings").submit();' class='ym-button' value='<?php $clang->eT("Save settings"); ?>' /></div>
		</form>
</div>
