	...
	<nav id="nav">
		<div class="ym-wrapper">
			...
			<ul>
				<li>
            	<a href="<?php echo $this->createUrl("/admin"); ?>" title="<?php $clang->eT("Default Administration Page");?>"><strong><?php $clang->eT("Default Page");?></strong></a></li>
				<li><a href="<?php echo $this->createUrl("admin/user/index"); ?>" title="<?php $clang->eT("Create/Edit Users");?>" ><?php $clang->eT("Users Management");?></a></li>
	            ...
	            <?php
					...
					{ ?>
				 <li><a href="<?php echo $this->createUrl("admin/globalsettings"); ?>" title="<?php $clang->eT("Global settings");?>" >
				    <?php $clang->eT("Global settings");?></a></li>
				<?php } ?>
				<?php
