...
<?php
	...
	<td align='center'><strong><?php echo $mur['users_name'];?></strong></td>
				<td align='center'><input type='email' size='30' name='email'
					value="<?php echo $mur['email'];?>" /></td>
				<td align='center'><input type='text' size='30' name='full_name'
					value="<?php echo $mur['full_name'];?>" /> <input type='hidden'
					name='user' value="<?php echo $mur['users_name'];?>" /> <input
					type='hidden' name='uid' value="<?php echo $mur['uid'];?>" /></td>
				<td align='center'><input type='password' name='pass'
					value="%%unchanged%%" /></td>
<?php } ?>
</tr>
	...
	<p>
		<input class='ym-button' type='submit' value='<?php $clang->eT("Save");?>' /><input type='hidden' name='action' value='moduser' />
	</p>
</form>